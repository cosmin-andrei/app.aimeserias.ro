  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "dropdown-exit": "dropdown-exit 0.15s cubic-bezier(0.4, 0, 1, 1) forwards",
        "modal-enter": "modal-enter 0.28s cubic-bezier(0.16, 1, 0.3, 1) forwards",
        "modal-exit": "modal-exit 0.15s cubic-bezier(0.4, 0, 1, 1) forwards",
        "backdrop-enter": "backdrop-enter 0.22s ease-out forwards",
        "backdrop-exit": "backdrop-exit 0.15s ease-out forwards",
        "auth-step-forward":
          "auth-step-forward 0.28s cubic-bezier(0.16, 1, 0.3, 1) forwards",
        "auth-step-back":
          "auth-step-back 0.28s cubic-bezier(0.16, 1, 0.3, 1) forwards",
        "sidebar-slide-in":
          "sidebar-slide-in 0.28s cubic-bezier(0.16, 1, 0.3, 1) forwards",
        "sidebar-slide-out":
          "sidebar-slide-out 0.22s cubic-bezier(0.4, 0, 1, 1) forwards",
      },
    },
  },
  plugins: [],
