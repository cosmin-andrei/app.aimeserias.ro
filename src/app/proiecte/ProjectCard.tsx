    ...
    return (
        ...
        >
            ...
            <div className="flex flex-1 flex-col p-4">
                ...
                <div className="mt-3 flex items-center justify-between gap-2 rounded-xl bg-[#fafcff] px-3 py-2.5 ring-1 ring-[#002050]/6 dark:bg-white/[0.04] dark:ring-white/[0.06]">
                    ...
                    {project.applicants != null && project.applicants > 0 && (
                        <span className="inline-flex shrink-0 items-center gap-1 rounded-full bg-[#16366d]/10 px-2 py-0.5 text-[10px] font-semibold text-[#16366d] dark:bg-white/[0.08] dark:text-[#c5d4f5]">
                            ...
                            {project.applicants} oferte
                        </span>
                    )}
                </div>

                <div className="mt-3 rounded-xl bg-gray-50/90 p-2.5 ring-1 ring-gray-100 dark:bg-white/[0.03] dark:ring-white/[0.06]">
                    <ClientProfile client={project.client} variant="compact" embedded />
                </div>
            </div>
        </Link>
    );
